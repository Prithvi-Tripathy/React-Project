...
const Home=()=>{
  ...
  const callAPI=async()=>{
    let body = await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=17.4946106&lng=78.3875336&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING");
    ...
    return (
        <div className="container-fluid home-container">
          <div>******************this section is to impliment filters and buttons****************************</div>
          <button onClick={()=>{ 
